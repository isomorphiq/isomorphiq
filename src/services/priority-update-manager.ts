...
import type { TaskPriorityChangedEvent } from "../core/events.ts";
...
export class PriorityUpdateManager {
    ...
    private handlePriorityChanged(event: TaskPriorityChangedEvent): void {
        const data = event.data as { taskId?: string; newPriority?: TaskPriority; oldPriority?: TaskPriority };
...
export class OptimizedPriorityService {
     ...
     */
        ...
        try {
            ...
            globalEventBus.emit("task_priority_changed", {
                taskId,
