...
console.log('  \'{"command": "node", "args": ["src/mcp-server.ts"], "env": {}}\'')
console.log('')
console.log('Or run OpenCode with MCP server inline:')
console.log('opencode run --mcp-server \'{"name": "task-manager", "command": "node", "args": ["src/mcp-server.ts"]}\' "Your prompt here"')
console.log('')
