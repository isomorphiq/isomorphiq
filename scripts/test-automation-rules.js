...
async function testAutomationRules() {
    ...
    try {
        ...
        const bugTask = await pm.createTask('Fix: Critical login issue', 'Users cannot log in with valid credentials', 'high', [], 'test-user');
        ...
        const featureTask = await pm.createTask('Feature: Add dark mode', 'Implement dark mode for the application', 'low', // This should be auto-set to medium
        [], 'test-user');
        ...
        const devTask = await pm.createTask('Task: Implement user authentication', 'Add login and registration functionality', 'medium', [], 'test-user');
        // Mark task as done
...
//# sourceMappingURL=test-automation-rules.js.map