    ...
    constructor() {
        super({
            ...
            properties: {
                enabled: {
                    type: "boolean",
                    description: "Enable/disable documentation generator plugin",
                    default: true
                },
                priority: {
                    type: "number",
                ...
                settings: {
                    ...
                    properties: {
                        ...
                        includeExamples: {
                            type: "boolean",
                            description: "Include code examples in generated docs",
                            default: true
                        },
                        generateApiDocs: {
                            type: "boolean",
                        ...
                        targetAudience: {
                            ...
                            enum: ["developers", "users", "administrators", "all"],
                            default: "developers"
                        },
                        updateFrequency: {
                            type: "string",
                            description: "How often to update documentation",
                            enum: ["daily", "weekly", "monthly", "on-change"],
                            default: "on-change"
                        }
                    },
                    required: ["outputFormat", "targetAudience"]
                }
            },
...
${this.getAudienceGuidance(settings.targetAudience)}`,
