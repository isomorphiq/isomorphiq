...
describe("Dashboard Integration Verification", () => {
    describe("API Endpoint Tests", () => {
        it("should serve dashboard HTML", async (t) => {
            if (!serverAvailable) {
                t.skip();
                return;
            }
        ...
        it("should provide comprehensive metrics", async (t) => {
            if (!serverAvailable) {
                t.skip();
                return;
            }
        ...
        it("should support task CRUD operations", async (t) => {
            if (!serverAvailable) {
                t.skip();
                return;
            }
        ...
        it("should support advanced task filtering", async (t) => {
            if (!serverAvailable) {
                t.skip();
                return;
            }
        ...
        it("should provide queue status and analytics", async (t) => {
            if (!serverAvailable) {
                t.skip();
                return;
            }
        ...
        it("should provide system health monitoring", async (t) => {
            if (!serverAvailable) {
                t.skip();
                return;
            }
        ...
        it("should provide performance metrics", async (t) => {
            if (!serverAvailable) {
                t.skip();
                return;
            }
        ...
        it("should provide activity logging", async (t) => {
            if (!serverAvailable) {
                t.skip();
                return;
            }
        ...
        it("should support notification subscriptions", async (t) => {
            if (!serverAvailable) {
                t.skip();
                return;
            }
