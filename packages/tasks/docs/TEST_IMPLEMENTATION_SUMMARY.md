...
```bash
yarn run test-analytics      # Test analytics accuracy
yarn run test-dashboard      # Test dashboard functionality  
yarn run test-reports        # Test report generation
```

#### Run Comprehensive Test Suite:
```bash
yarn run test-comprehensive   # Run all test suites
```
