...
export type IApprovalWorkflowRepository = {
...
export type ITaskApprovalRepository = {
...
export type IApprovalTemplateRepository = {
...
export type IApprovalWorkflowService = {
    workflow: {
        create(
...
export class ApprovalWorkflowService implements IApprovalWorkflowService {
	...
	private groupApprovalsByWorkflow(approvals: TaskApproval[]): Record<string, number> {
		...
		return approvals.reduce((groups: Record<string, number>, approval: TaskApproval) => {
