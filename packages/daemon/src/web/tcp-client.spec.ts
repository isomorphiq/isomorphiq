...
describe("DaemonTcpClient", () => {
    ...
    describe("Task Creation", () => {
        it("should create task with valid data", async () => {
            ...
            assert.ok(mockSendCommand.called);
            assert.strictEqual(mockSendCommand.mock.calls[0][0], "create_task");
            assert.deepEqual(mockSendCommand.mock.calls[0][1], taskData);
    ...
    describe("Task Listing", () => {
        it("should list all tasks", async () => {
            ...
            assert.ok(mockSendCommand.called);
            assert.strictEqual(mockSendCommand.mock.calls[0][0], "list_tasks");
            assert.ok(result.success);
        ...
        it("should list tasks with filters", async () => {
            ...
            assert.ok(mockSendCommand.called);
            assert.strictEqual(mockSendCommand.mock.calls[0][0], "list_tasks_filtered");
            assert.deepEqual(mockSendCommand.mock.calls[0][1], { filters });
            assert.ok(result.success);
        });
    });
    ...
    describe("Task Updates", () => {
        it("should update task status", async () => {
            ...
            assert.ok(mockSendCommand.called);
            assert.strictEqual(mockSendCommand.mock.calls[0][0], "update_task_status");
            assert.deepEqual(mockSendCommand.mock.calls[0][1], { id: taskId, status: newStatus });
            assert.ok(result.success);
        ...
        it("should update task priority", async () => {
            ...
            assert.ok(mockSendCommand.called);
            assert.strictEqual(mockSendCommand.mock.calls[0][0], "update_task_priority");
            assert.deepEqual(mockSendCommand.mock.calls[0][1], { id: taskId, priority: newPriority });
            assert.ok(result.success);
    ...
    describe("Task Deletion", () => {
        it("should delete task", async () => {
            ...
            assert.ok(mockSendCommand.called);
            assert.strictEqual(mockSendCommand.mock.calls[0][0], "delete_task");
            assert.deepEqual(mockSendCommand.mock.calls[0][1], { id: taskId });
            assert.ok(result.success);
    ...
    describe("Task Monitoring", () => {
        it("should create monitoring session", async () => {
            ...
            assert.ok(mockSendCommand.called);
            assert.strictEqual(mockSendCommand.mock.calls[0][0], "create_monitoring_session");
            assert.deepEqual(mockSendCommand.mock.calls[0][1], { filters });
            assert.ok(result.success);
        ...
        it("should subscribe to task updates", async () => {
            ...
            assert.ok(mockSendCommand.called);
            assert.strictEqual(mockSendCommand.mock.calls[0][0], "subscribe_to_task_updates");
            assert.deepEqual(mockSendCommand.mock.calls[0][1], { sessionId, taskIds });
            assert.ok(result.success);
        });
    });
    ...
    describe("Connection Management", () => {
        it("should check connection status", async () => {
            ...
            // Temporarily replace createConnection
            const originalCreateConnection = require("node:net").createConnection;
            require("node:net").createConnection = mockCreateConnection;
            ...
            try {
                ...
                // Restore original
                require("node:net").createConnection = originalCreateConnection;
            }
        });
