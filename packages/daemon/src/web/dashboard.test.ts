...
describe("Task Dashboard", () => {
    ...
    let mockProductManager: jest.Mocked<ProductManager>;
    let mockWebSocketManager: jest.Mocked<WebSocketManager>;
    let mockAnalyticsService: jest.Mocked<DashboardAnalyticsService>;
    let environmentServices: Map<string, { environment: string; productManager: ProductManager; webSocketManager: WebSocketManager; analyticsService: DashboardAnalyticsService }>;
