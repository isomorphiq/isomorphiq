...
export const SearchSortStruct = struct.name("SearchSort")<
    z.output<typeof SearchSortSchema>,
    z.input<typeof SearchSortSchema>
>(SearchSortSchema);
...
export const SearchQueryStruct = struct.name("SearchQuery")<
    z.output<typeof SearchQuerySchema>,
    z.input<typeof SearchQuerySchema>
>(SearchQuerySchema);
...
export const SearchHighlightStruct = struct.name("SearchHighlight")<
    z.output<typeof SearchHighlightSchema>,
    z.input<typeof SearchHighlightSchema>
...
export const SearchHighlightsStruct = struct.name("SearchHighlights")<
    z.output<typeof SearchHighlightsSchema>,
    z.input<typeof SearchHighlightsSchema>
...
export const SearchFacetsStruct = struct.name("SearchFacets")<
    z.output<typeof SearchFacetsSchema>,
    z.input<typeof SearchFacetsSchema>
>(SearchFacetsSchema);
...
export const SearchResultStruct = struct.name("SearchResult")<
    z.output<typeof SearchResultSchema>,
...
export const SavedSearchStruct = struct.name("SavedSearch")<
    z.output<typeof SavedSearchSchema>,
    z.input<typeof SavedSearchSchema>
>(SavedSearchSchema);
...
export const CreateSavedSearchInputStruct = struct.name("CreateSavedSearchInput")<
    z.output<typeof CreateSavedSearchInputSchema>,
    z.input<typeof CreateSavedSearchInputSchema>
...
export const UpdateSavedSearchInputStruct = struct.name("UpdateSavedSearchInput")<
    z.output<typeof UpdateSavedSearchInputSchema>,
    z.input<typeof UpdateSavedSearchInputSchema>
