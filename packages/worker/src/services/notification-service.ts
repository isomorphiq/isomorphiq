...
return this.sendNotification(notification);
    ...
    private isInQuietHours(preferences: NotificationPreferences): boolean {
        ...
        const now = new Date();
        const resolveCurrentTimeInMinutes = (timezone: string): number => {
            try {
                ...
                const minute = minutePart ? Number.parseInt(minutePart, 10) : NaN;
        ...
        const currentTime = resolveCurrentTimeInMinutes(preferences.quietHours.timezone);
